  ...
  public: {
    Tables: {
      documento: {
        ...
        Relationships: [
          {
            foreignKeyName: "documento_id_usuario_fkey"
            columns: ["id_usuario"]
            isOneToOne: false
      ...
      documento_vehicular: {
        ...
        Relationships: [
          {
            foreignKeyName: "documento_vehicular_placa_vehiculo_fkey"
      ...
      pasajeros: {
        ...
        Relationships: [
          {
            foreignKeyName: "pasajeros_id_usuario_fkey"
            columns: ["id_usuario"]
            isOneToOne: false
            referencedRelation: "usuario"
            referencedColumns: ["id_usuario"]
          ...
          {
            foreignKeyName: "pasajeros_id_viaje_fkey"
            columns: ["id_viaje"]
            isOneToOne: false
      ...
      ruta: {
        Row: {
          id_ruta: number
          longitud: number
          punto_llegada: unknown
          punto_partida: unknown
          trayecto: unknown
        }
        Insert: {
          id_ruta?: number
      ...
      vehiculo: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "vehiculo_tipo_fkey"
            columns: ["tipo"]
            isOneToOne: false
      ...
      viaje: {
        ...
        Relationships: [
          {
            foreignKeyName: "viaje_id_conductor_fkey"
    ...
    Functions: {
      ...
      insertar_ruta: {
        Args: {
          p_longitud: number
          p_punto_partida_wkt: string
          p_punto_llegada_wkt: string
          p_trayecto_wkt: string
        }
        Returns: {
          id_ruta_nuevo: number
        }[]
      }
      json: {
        Args: { "": unknown }
